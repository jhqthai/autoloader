...
//int tune = 0;
//char wav_tasks;
//unsigned int wav[(255)], wav_index, wav_msg, wav_tempo = 0;
//unsigned int notes[]   = {(191),(191),(170),(191),(143),(151)};
//unsigned int tempo[]   = {(10000),(8000),(12000),(10000),(10000),(40000)};
//
//typedef enum{
//    WAVE_INI = 0,
//    WAVE_IDLE,      
...
//        command_interpreter();
//        system_eventHandler();
//        system_userInterface();
//        process_ToneGenerator();
//        process_LcdController();
//        process_KeyController();
//        process_OutputDevices();
//        process_DebugOutput();
//        process_SerialComs();
//        process_Backlight();
//    }
